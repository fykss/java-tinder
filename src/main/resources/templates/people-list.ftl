                            ...
                            <#list listUsers as listItem>
                                    <tr class="table_row">
                                        <td class="align_left align-middle-my" width="10">
                                            ...
                                            <label class="list_label" for="${listItem.getIdUser()}">
                                        ...
                                        <td  class="align-middle align-middle-my">
                                            ...
                                            <button style="display: none" id="${listItem.getIdUser()}" value="${listItem.getIdUser()}" name="userId" class="btn_submit" form="form_like" type="submit"  >Send</button>
                                        </td>
                                    </tr>
                                </#list>
                            </tbody>
                        ...
                        <div class="col-md-12 chat-header">
                            <div class="row header-one text-white p-1">
                                ...
                                <div class="col-md-6 options text-right pr-0">
                                    <i id="wrap" class="fa fa-window-minimize hide-chat-box hover text-center pt-1" onclick="closeChat()"></i>
